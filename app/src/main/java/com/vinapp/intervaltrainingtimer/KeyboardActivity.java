...
public class KeyboardActivity extends Activity {
    ...
    private void textViewColoring() {
        ...
        switch (DATA_TYPE) {
            case "number":
                if (changedCharsPosition[0]) {
                    spannableText.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.darkThemeColorAccent)), 0, spannableText.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                break;
            case "time":
                int i;
                ...
                if (i <= 2) {
                    spannableText.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.darkThemeColorAccent)), 0, i, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else {
                    spannableText.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.darkThemeColorAccent)), 0, 2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    spannableText.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this, R.color.darkThemeColorAccent)), 3, i + 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                break;
            default:
                break;
